...
2.  Approximately 6.6% (R2=.066R^2 = .06) of the variance in satisfaction with work–life balance is accounted for by a model including satisfaction with one’s financial situation.
...
Categorical variables need to be added to regression models as dummy variables with values of 0 or 1.
...
1.  Working full-time is associated with lower satisfaction with work-life balance with an average score -1.187 less than those working part-time when we control for differences in satisfaction with financial situation and gender.
